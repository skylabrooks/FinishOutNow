...
import { X, CheckCircle, AlertCircle, DollarSign, Zap, Hammer, FileCheck, Building, User, Info, Shield, Monitor, PenTool, MapPin, BadgeCheck, HelpCircle, Mail, Calendar, Cable } from 'lucide-react';
