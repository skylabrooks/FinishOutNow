...
import { X, Building, User, Mail, Phone, Globe, Sparkles, Save, Activity } from 'lucide-react';
            ...
            <div className="pt-4 border-t border-slate-800 flex justify-between gap-3">
                 ...
                 {onOpenDiagnostics && (
                     <button
                        ...
                        className="px-4 py-2 text-slate-500 hover:text-purple-400 hover:bg-purple-900/20 text-xs font-medium rounded-lg transition-colors flex items-center gap-2 border border-transparent hover:border-purple-500/30"
                     >
