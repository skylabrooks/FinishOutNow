...
import { Coordinates } from '../services/geocoding/GeocodingService';
import { usePermitMapData } from './usePermitMapData';
...
export default function PermitMap({ permits, onSelect }: Props) {
  // Use extracted hook for marker data
  const markerPoints = usePermitMapData(permits);
