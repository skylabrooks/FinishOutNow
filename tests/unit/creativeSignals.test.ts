...
import { linkSignalsToLeads } from '../../services/leadManager';
...
describe('Creative Signals Integration', () => {
  it('should boost lead score when signal matches lead by address', () => {
    // Note: This is a mock test. In production, the linkSignalsToLeads function 
    // is defined in leadManager.ts but not exported. This test demonstrates the expected behavior.
